...
// Sauvegarde les t�ches dans un fichier
...
// Charge les t�ches depuis un fichier
...
void GestionDesNationalites::afficherNationalites(const int &idClient)
{
    ...
    {
        cout << "Aucune nationalit� trouv� pour le client " << idClient << endl;
    }
}
